...
init = 'diag' #'randgauss'
n_rnn = 32 #size of the network N
...
filedir = os.path.join('data', 'smoke_test', folder)
train.train(filedir, seed=seed,  max_steps=1000, ruleset = ruleset, rule_trains = rule_trains,
