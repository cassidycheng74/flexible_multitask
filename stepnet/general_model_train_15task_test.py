...
filedir = os.path.join('data', 'driscoll_15task_20M', folder)
train.train(filedir, seed=seed,  max_steps=20000000, ruleset = ruleset, rule_trains = rule_trains,
    hp = { 'activation' : activation,
            ...
            display_step=5000, rich_output=False)
